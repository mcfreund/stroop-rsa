...
write.csv(blups, here("out", "behav", "stroop_blups_rt_group201902_validation.csv"),  row.names = FALSE)  ## blups
saveRDS(fit1.het.trim, here("out", "behav", "fit1-het-trim_group201902_validation.RDS"))
