...
X.super <- m.super[ids$is.analysis.group, -(1:2)]

## find lambda and fit

lambdas.super <- tune_lambda(X.super, strooprt, alpha = 0.5, selection_crit = function(fit) fit$lambda.1se)
hist(lambdas.super)
lambda.best.super <- Mode(lambdas.super)

net.super <- glmnet(x = X, y = strooprt, lambda = lambda.best.super, alpha = 0.5)
coef(net.super)
...
hist(lambdas.md)
lambda.best.md <- Mode(lambdas.md)
