...
(contrast.dmfc_L.lfp_R <- summary(glht(mods$dmfc_L.lfp_R, W), test = adjusted("none")))



## save results

indiv.mod.objs.sep <- list(
  mods = mods, ps = pvals, 
  contrasts = list(contrast.dmfc_L, contrast.lppc_R, contrast.dlpfc_R, contrast.dmfc_L.lfp_R)
  )
saveRDS(indiv.mod.objs.sep, here("out", "indiv", "indiv_separate.RDS"))
