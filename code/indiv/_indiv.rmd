...
## within-region interactions (contrasts on slopes): alternate ROI definitions

`r spin_child('wn_roi_contrast_alt.R')`
...
## alternate ROI definitions

`r spin_child('model_selection_alt.R')`

## exploratory whole-cortex analysis

`r spin_child('model_selection_explor.R')`
