...
rois.targt <- stats.group.pro[param == "target" & p.fdr < 0.05, roi]
rois.distr <- stats.group.pro[param == "distractor" & p.fdr < 0.05, roi]
rois.incon <- stats.group.pro[param == "incongruency" & p.fdr < 0.05, roi]
