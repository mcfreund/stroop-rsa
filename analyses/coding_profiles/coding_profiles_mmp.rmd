...
knitr::opts_chunk$set(cache = TRUE, dpi = 40)
...
stats.coding.targt %>% build.overlay("v") %>% plot_surface(underlay = hcp)
```
...
stats.group.tdic[param == "incongruency"] %>% build.overlay("v") %>% plot_surface(underlay = hcp)
```
...
Test statistics (sum of sign ranks)
```{r preference_targt_v, dev = "png", fig.width = 20, fig.height = 10, results = "asis"}
stats.coding.targt %>% 
...
Test statistics (sum of sign ranks)
```{r preference_incon-vs-distr_v, dev = "png", fig.width = 20, fig.height = 10, results = "asis"}
stats.coding.incon  %>% 
...
```{r tost_targt-vs-distr_v, dev = "png", fig.width = 20, fig.height = 10, results = "asis"}
stats.coding.targt 
...
```{r tost_targt-vs-incon_v, dev = "png", fig.width = 20, fig.height = 10, results = "asis"}
stats.coding.targt 
